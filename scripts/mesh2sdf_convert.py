...
def main(argv):
    ...
    output_dir = os.path.join(dir_name, mesh_file_woext[0])
    os.makedirs(output_dir, exist_ok=True)

    if not args.normalize:
        ply = os.path.join(output_dir, mesh_file_woext[0] + '_watertight.ply')
        stl = os.path.join(output_dir, mesh_file_woext[0] + '_watertight.stl')
        csv_path = os.path.join(output_dir, mesh_file_woext[0] + '.csv')
    else:
        ply = os.path.join(output_dir, mesh_file_woext[0] + '_normalized_watertight.ply')
        stl = os.path.join(output_dir, mesh_file_woext[0] + '_normalized_watertight.stl')
        csv_path = os.path.join(output_dir, mesh_file_woext[0] + '_normalized.csv')
